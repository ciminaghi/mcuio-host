...
static inline unsigned mcuio_devs_per_bus(void)
{
	return BIT(mcuio_addr_dev_bits);
}

static inline unsigned mcuio_funcs_per_dev(void)
{
	return BIT(mcuio_addr_func_bits);
}
